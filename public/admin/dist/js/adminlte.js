...
* should be included in all pages. It controls some master
...
+function ($) {
  ...
  Layout.prototype.fix = function () {
    // Remove overflow from .wrapper if master-boxed exists
