                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 text-right">
                        <div class="btn-group text-center">
                            <a href="/category" class="btn btn-success btn-sm btn-default"><i class="fa fa-eye fa-1x"></i></a>
                            <a href="/category/{{$result->id}}/edit" class="btn btn-success btn-sm btn-default"><i class="fa fa-edit fa-1x"></i></a>
                                    ...
                                    <div id="Summery" class="tab-pane fade in active">
                                        ...
                                        <div class="table-responsive panel">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td class="text-success"><i class="fa fa-user"></i> Category Name</td>
                                                    <td>{{ $result->name }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-success"><i class="fa fa-list-ol"></i> Category Label</td>
                                                    <td>{{ $result->label }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-success"><i class="fa fa-book"></i> Status</td>
                                                    <td>{{ $result->status }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-success"><i class="fa fa-group"></i> user</td>
